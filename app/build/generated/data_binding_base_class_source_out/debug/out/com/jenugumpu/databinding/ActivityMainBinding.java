...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_header_stock;
      TextView tvHeaderStock = ViewBindings.findChildViewById(rootView, id);
      if (tvHeaderStock == null) {
        break missingId;
      }
